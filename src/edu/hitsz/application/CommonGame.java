...
public class CommonGame extends Game{
    ...
    public AbstractAircraft getAircraft() {
        ...
        if (mob)
        {
            ...
            enemy = mobEnemyFactory.getEnemyAircraft_Common();
        }
        if (elite)
        {
            EliteEnemyFactory eliteEnemyFactory = new EliteEnemyFactory();
            enemy = eliteEnemyFactory.getEnemyAircraft_Common();
        ...
        if (boss)
        {
            ...
            enemy = bossEnemyFactory.getEnemyAircraft_Common();
        ...
        System.out.println("精英机产生概率提高到:" + (0.6 + temp));
